...
<body class="dark">
    <div id="wrapper" class="clearfix">
      ...
      -->
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-3 wow fadeInLeft animation-delay2">
                                <div class="sm-height-auto" data-bg-img="{{ asset('frontend') }}/assets/images/about/h2.jpg">
                                    <div class="p-5">
                                        ...
                                        <div style="height: 200px; margin-top:10px">
                                            <p style="text-align: left;" class="lead text-white-f1">Certainly! If you’re interested in online courses and certifications, Certainly! If you’re interested in online courses and certifications,Certainly! If you’re interested in online courses and certifications,</p>
                                        </div>
                                        <ul style="margin-top: 20px;" class="pull-left flip hidden-sm hidden-xs">
                                            <li>
                                                <a class="btn btn-dark  font-15 bs-modal-ajax-load mt-0 p-10 " href="{{ url('/offered_course_batch/show') }}">View Offered</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 col-sm-12 col-md-3 wow fadeInLeft animation-delay2">
                                <div class="sm-height-auto" data-bg-img="{{ asset('frontend') }}/assets/images/about/h2.jpg">
                                    <div class="p-5">
                                        <h3 class="text-white text-uppercase mt-10 hvr-bounce-to-left">Taken Course</h3>
                                        <div style="height: 200px; margin-top:10px">

                                            <p style="text-align: left;" class="lead text-white-f1">Certainly! Let’s explore the concept of university courses. When you attend a university, </p>
                                        </div>
                                        <ul style="margin-top: 20px;" class="pull-left flip hidden-sm hidden-xs">
                                            <li>
                                                <!-- Modal: Book Now Starts -->

                                                <a class="btn btn-dark  font-12 bs-modal-ajax-load mt-0 p-10 pr-5" type="button" class="btn btn-primary" href="{{ route('all.taken_course') }}">View Taken Course</a>
                                                <!-- Modal: Book Now End -->
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-lg-2 col-sm-12 col-md-3 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
                                <div class="sm-height-auto" data-bg-img="{{ asset('frontend') }}/assets/images/about/h2.jpg">
                                    <div style=margin-top:5px" class="p-5">
                                        <h3 class="text-white text-uppercase">Complete Course</h3>
                                        <p style="text-align: left;" class="lead text-white-f1">Certainly! Completing an online course can be a rewarding experience. Here are some tips to help you successfully finish your course:</p>
                                        <ul style="margin-top: 20px;" class="pull-left flip hidden-sm hidden-xs">
                                            <li>
                                                <!-- Modal: Book Now Starts -->
                            ...
                            <div class="col-lg-2 col-sm-12 col-md-2 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay1">
                                <div class="sm-height-auto" data-bg-img="{{ asset('frontend') }}/assets/images/about/h2.jpg">
                                    <div class="p-5">
                                        <h3 style="text-align: left;" class="text-white text-uppercase">Retake Course</h3>
                                        <p class="lead text-white-f1">Submit a retake application before the term starts via the “Retake application” function.

                                            Alternatively, during the first two weeks of the term, use the “Application for Add/Drop”</p>
                                        <ul style="margin-top: 20px;" class="pull-left flip hidden-sm hidden-xs">
                                            <li>
                                                <!-- Modal: Book Now Starts -->
                                                <a class="btn btn-dark  font-12 bs-modal-ajax-load mt-0 p-10 pr-15" href="{{ route('all.retake_course') }}">View Retake Course</a>
                                                <!-- Modal: Book Now End -->
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
                                ...
                                <div class="icon-box clearfix m-0 p-0 pb-10">
                                    ...
                                    <div class="ml-120 ml-sm-0">
                                        ...
                                        <p class="text-white">The title "World's Best Teacher" is a prestigious recognition often given to educators who have made significant contributions to their field. While there isn't a single universally recognized "World's Best Teacher," various organizations and institutions celebrate outstanding teachers through awards, nominations, and accolades.

                                            If you're looking for inspiration or want to learn from exceptional educators, consider exploring profiles of renowned teachers, their teaching philosophies, and their impact on education. You might find stories of teachers who have transformed lives, pioneered innovative teaching methods, or advocated for educational equity.

                                            Remember that greatness in teaching isn't always about global recognition; it's often about the positive impact a teacher has on their students' lives. Whether you're an aspiring teacher or simply curious, keep seeking knowledge and sharing it with others! 🌟 </p>
                                    </div>
                                </div>
                                <div class="icon-box clearfix m-0 p-0 pb-10">
                                    <a href="#" class="icon icon-circled bg-white icon-lg pull-left flip sm-pull-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 hidden-xs pl-40">
                                ...
                                <div id="accordion1" class="panel-group accordion">
                                    <div class="panel">
                                        <div class="panel-title"> <a class="active" data-parent="#accordion1" data-toggle="collapse" href="#accordion11" aria-expanded="true"> <span class="open-sub"></span> Why this University is Best?</a> </div>
                                        <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>Choosing a university is a significant decision, and each person's reasons may vary. Here are some common factors that influence why students choose a particular university:
                                                    Remember, the "best" university varies based on individual preferences and goals. Consider what matters most to you and explore universities that align with your aspirations!
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion12" class="" aria-expanded="true"> <span class="open-sub"></span> What is the Best Curriculum and Programs of University ?</a> </div>
                                        <div id="accordion12" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>**Curriculum and Programs**: Students often consider the study program, curriculum, and available majors. Some universities offer unique courses or specialized programs that align with their interests and career goals¹.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion13" class="" aria-expanded="true"> <span class="open-sub"></span> What is the Location of the University ?</a> </div>
                                        <div id="accordion13" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>**Location**: The university's location 51 Siddheswari Rd, Dhaka 1217 matters. Some students prefer urban campuses, while others enjoy a more rural or scenic setting. Proximity to family, job opportunities, and lifestyle also play a role</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion14" class="" aria-expanded="true"> <span class="open-sub"></span> Why the Faculty and Research Opportunities is Best of the University ?</a> </div>
                                        <div id="accordion14" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>**Faculty and Research Opportunities**: Access to top-class professors, research opportunities, and cutting-edge facilities can be compelling reasons to choose a university</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion15" class="" aria-expanded="true"> <span class="open-sub"></span> Why this Financial Considerations is Best?</a> </div>
                                        <div id="accordion15" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>Financial Considerations**: Scholarships, bursaries, and support funds influence decisions. Students weigh tuition costs against the value they'll receive from their education</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel">
                                        <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion16" class="" aria-expanded="true"> <span class="open-sub"></span> Why this Campus is Best?</a> </div>
                                        <div id="accordion16" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                                            <div class="panel-content">
                                                <p>**Campus Facilities**: Libraries, museums, sports facilities, and extracurricular activities contribute to the overall university experience</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="section-title mb-30">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3 text-center">
                                ...
                                <p class="text-white mb-0">Universities host a variety of events throughout the year. Here are some examples of upcoming events you might find at different universities:

                                    Conferences and Seminars: These events often focus on academic, political, or social issues and are a platform for discussion and networking1.
                                    Special Programs: Universities may offer special programs like summer internships or workshops in various departments<br> voluptatem obcaecati!</p>
                            </div>
                        </div>
                    </div>
                    <div class="section-content">
                                ...
                                <div class="pricing table-horizontal maxwidth400">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 p-30 pl-sm-50">
                                            <h4 class="mt-0 mb-5"><a href="#" class="text-white">Music Performances: </a></h4>
                                            <ul class="list-inline mb-5 text-white">
                                                <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2016 |</li>
                                                <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>Dhaka Bangladesh</li>
                                            </ul>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <div class="pricing table-horizontal maxwidth400">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 p-30 pl-sm-50">
                                            <h4 class="mt-0 mb-5"><a href="#" class="text-white">Special Programs:</a></h4>
                                            <ul class="list-inline mb-5 text-white">
                                                <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2016 |</li>
                                                <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>New York</li>
                                            </ul>
                                            <p class="mb-15 mt-15 text-white"> Universities may offer special programs like summer internships or workshops in various department</p>
                                            <a class="text-white font-weight-600" href="#">Read More →</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <div class="pricing table-horizontal maxwidth400">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 p-30 pl-sm-50">
                                            <h4 class="mt-0 mb-5"><a href="#" class="text-white">Exhibitions:</a></h4>
                                            <ul class="list-inline mb-5 text-white">
                                                <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2024 |</li>
                                                <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>New York</li>
                                            </ul>
                                            <p class="mb-15 mt-15 text-white">Exhibitions: Artistic and cultural exhibitions are common, showcasing topics like the impact of plastics or historical collections3.</p>
                                            <a class="text-white font-weight-600" href="#">Read More →</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 mb-30 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <div class="pricing table-horizontal maxwidth400">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 p-30 pl-sm-50">
                                            <h4 class="mt-0 mb-5"><a href="#" class="text-white">Open Days:</a></h4>
                                            <ul class="list-inline mb-5 text-white">
                                                <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2024 |</li>
                                                <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>New York</li>
                                            </ul>
                                            <p class="mb-15 mt-15 text-white">Open Days: These are opportunities for prospective students to visit the campus, meet faculty, and get a feel for university life4.</p>
                                            <a class="text-white font-weight-600" href="#">Read More →</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="entry-meta media mt-0 no-bg no-border">
                                            ...
                                            <div class="media-body pl-10">
                                                <div class="event-content pull-left flip">
                                                    <h4 class="entry-title text-white text-capitalize m-0"><a href="#">International Women's Day Celebration</a></h4>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>
                                                </div>
                                            </div>
                                        </div>
                                        <p class="mt-10">The faculty members of the Department of Civil Engineering, Stamford University Bangladesh have celebrated the International Women's Day 2024 on 11/3/2024 at the campus.
                                            The Dean, Faculty of Engineering, Professor Dr. B.C Basak was present with other faculty members of CEN in this delightful event.</p>
                                ...
                                <article class="post clearfix mb-sm-30">
                                    ...
                                    <div class="entry-content p-20 pr-10">
                                        <div class="entry-meta media mt-0 no-bg no-border">
                                            <div class="entry-date media-left flip text-center">
                                                <ul>
                                                    <li class="font-16 font-weight-600 border-bottom bg-white-f1 pt-5 pr-15 pb-5 pl-15">29</li>
                                                    <li class="font-12 text-white text-uppercase bg-theme-colored pt-5 pr-15 pb-5 pl-15">Feb</li>
                                                </ul>
                                            </div>
                                            <div class="media-body pl-10">
                                                <div class="event-content pull-left flip">
                                                    <h4 class="entry-title text-white text-capitalize m-0"><a href="#">
                                                            The 15th Asia Pharma Expo, 2024 held from February 29th to March 2nd, 2024.</a></h4>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>
                                                </div>
                                            </div>
                                        </div>
                                        <p class="mt-10">The 15th Asia Pharma Expo brought together the pharmaceutical professionals, researchers, entrepreneurs, and stakeholders from across Asia and beyond. Hosted at the Bangabandhu Bangladesh-China Friendship Exhibition Center (BBCFEC), </p>
                                        <div class="mt-10"> <a href="blog-single-left-sidebar.html" class="btn btn-theme-colored btn-sm">Read More</a> </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </article>
                                    ...
                                    <div class="entry-content p-20 pr-10">
                                        <div class="entry-meta media mt-0 no-bg no-border">
                                            <div class="entry-date media-left flip text-center">
                                                <ul>
                                                    <li class="font-16 font-weight-600 border-bottom bg-white-f1 pt-5 pr-15 pb-5 pl-15">28</li>
                                                    <li class="font-12 text-white text-uppercase bg-theme-colored pt-5 pr-15 pb-5 pl-15">March</li>
                                                </ul>
                                            </div>
                                            <div class="media-body pl-10">
                                                <div class="event-content pull-left flip">
                                                    <h4 class="entry-title text-white text-capitalize m-0"><a href="#">Congratulations and Warm Regards to Dhaka University's New Leaders
                                                    Mar 6, 2024</a></h4>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>
                                                    <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>
                                                </div>
                                        ...
                                        <p class="mt-10">A team of faculty members, led by the Chairperson of the Department of Pharmacy at Stamford University Bangladesh, recently visited the Department of Pharmacy at Dhaka University on March 4th and 5th. They extended sincere congratulations to the newly appointed Pro-Vice Chancellor (Academic), Professor Dr. Sitesh Chandra Bachar (DU);</p>
                                        <div class="mt-10"> <a href="blog-single-left-sidebar.html" class="btn btn-theme-colored btn-sm">Read More</a> </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </article>
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div data-address="121 King Street, Melbourne Victoria 3000 Australia" data-popupstring-id="#popupstring1" class="map-canvas autoload-map" data-mapstyle="style8" data-height="353" data-latlng="-37.817314,144.955431" data-title="sample title" data-zoom="12" data-marker="{{ asset('frontend') }}/assets/images/map-marker.png">
                                </div>
