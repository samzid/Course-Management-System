                    ...
                    <div class="widget no-border m-0">
                        <ul class="list-inline">
                            ...
                            <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-white"></i> <a
                                    class="text-white" href="#">{{ @Auth::user()->email }}</a> </li>
                            <li class="m-0 pl-10 pr-10"> <i class="fa fa-male" style="color:white"></i> <a
                                    class="text-white" href="#">{{ @Auth::user()->name }}</a> </li>
            ...
            <div class="container">
                <nav id="menuzord-right" class="menuzord default">
                    <a class="menuzord-brand pull-left flip" href="javascript:void(0)">
                        <img src="{{ asset('frontend') }}/assets/images/7.png" alt="logo not found">
                    </a>
                    ...
                    <ul class="menuzord-menu onepage-nav">
                        ...
                        <li>
                            <button class="btn btn-primary dropdown-toggle" type="button"
                                ...
                                data-toggle="dropdown">Login Protal
...
<li style="border-radius: 10px" class="btn btn-primary" ><a style="color:white ; font-weight: bold ; font-size:16px ;"  href="#register">Register</a></li>
 ...
 @endif
                                        <li style="border-radius: 10px" class="btn btn-primary"><a
                                                style="color:white ; font-weight: bold ; font-size:16px ;"
                                                href="{{ route('alladmin.login') }}">Admin Login</a></li>
