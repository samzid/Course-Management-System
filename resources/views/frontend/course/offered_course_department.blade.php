...
@section('main_content')
    ...
    @php
        ...
        $Offeredcourse_Views = App\Models\OfferedCourse::where('department', Auth::user()->department)->get();
    ...
    <section class="section coming-soon" data-section="section3" id="register">
        <div class="row">
            <div class="col-8 tabel_container" style="margin-left: 90px">
                <h3 style="color: white">All Offered Course of {{ Auth::user()->department }} Department <span
                        style="margin-left: 40px"> <a type="button" class="btn btn-primary btn-lg"
                            href="{{ route('view.Offered_course_batch') }}">View Course Your {{ Auth::user()->batch }} Batch
                        </a></span></h3>
